 ...
 * @author vfontoura
 */
public class SolutionListOutputClustering {
  ...
  public SolutionListOutputClustering(List<? extends Solution<?>> solutionList) {
  ...
  public SolutionListOutputClustering setVarFileOutputContext(FileOutputContext fileContext) {
    varFileContext = fileContext;

    return this;
  }

  public SolutionListOutputClustering setFunFileOutputContext(FileOutputContext fileContext) {
    funFileContext = fileContext;

    return this;
  }

  public SolutionListOutputClustering setObjectiveMinimizingObjectiveList(List<Boolean> isObjectiveToBeMinimized) {
    this.isObjectiveToBeMinimized = isObjectiveToBeMinimized ;

    return this;
  }

  public SolutionListOutputClustering setSeparator(String separator) {

...
public class ClusteringNSGAII<S extends Solution<?>> implements Algorithm<List<S>> {
   ...
   * Constructor
   */
  public ClusteringNSGAII(Problem<S> problem, int maxEvaluations, int populationSize,
